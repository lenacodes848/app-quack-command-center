...
6. Remaining CI hardening (pin first-party actions, run the toolchain checks in CI) and the scanner gaps, listed in `research.md` under Follow-ups and known gaps.
